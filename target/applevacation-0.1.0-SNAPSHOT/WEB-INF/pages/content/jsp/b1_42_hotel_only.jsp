<div id="booking-container">
	<div class="selection_header corner-bottom border-all gradient-transparent gradient">
		<h1 class="left">Book Your Hotel</h1>
		<div class="clearfix"></div>
		<!-- Clear -->
		<div class="bookingtabs">
			<div class="bookingtab active hotel">
				<div class="title">
					<span class="icon icon-booking-hotel">icon</span> Hotel &amp; Rooms
				</div>
				<div class="details">
					<p class="black">JUN 10-JUN 16</p>
					<p>
						Dreams Cancun Resort + Spa <span>Deluxe Ocean Front Room</span>
					</p>
				</div>
				<!-- end details -->
			</div>
			<div class="bookingtab extras">
				<div class="title">
			...
			<div class="bookingtab booking-confirmation">
				<div class="title">
					<span class="icon icon-booking-confirmation"></span> Booking
					Confirmation
				</div>
				...
				<div class="sidebar-slidetoggle">
					...
					<div class="apple-rating">
						<select id="webmenu" name="webmenu">
							<option value="Luxurious0" data-image="<%=request.getContextPath()%>/res/images/red-apple-icon.png">Luxurious
							</option>
						...
						<div class="Package-veiw-list Recommend">
							...
							<div class="Package-info-L">
								<a class="Selectedhotel" href="#">selected hotel</a> <img
									src="<%=request.getContextPath()%>/res/images/find-vacation-temp.png" alt="">
								...
								<ul class="Package-Slider-content" id="ulSliderContainer"
									...
									<li>
										...
										<div class="Price-block-bottomright">
											<div class="Price-block">
												+<p class="price">$<b>519</b>.99
												</p>
											</div>
											<p class="inline-block">PER PERSON</p>
										</div> <a class="btn-light-blue continue" href="${pageContext.request.contextPath}/b1_33_extrassummary.html">Book Room</a> <a><img
											src="<%=request.getContextPath()%>/res/images/slider-img1.png" alt=""></a>
									</li>
									<li class="no-image-li">
										...
										<div class="Price-block-bottomright">
											...
											<p class="inline-block">PER PERSON</p>
										</div> <a href="${pageContext.request.contextPath}/b1_33_extrassummary.html" class="btn-light-blue continue">Book Room</a>
										<div class="no-image">
