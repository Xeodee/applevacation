...
<link href="css/b1_58_Book_Modal.css" rel="stylesheet" type="text/css" media="screen" />
<!-- Popups-->
<div class="fixed-layout-blacktransparent">
<div id="b1_58_Book_Modal" class="package_4plus_rooms">
    ...
    <div class="content">
	  ...
	  <div id="panel-find-it-fast" class="panel">
					...
					<div class="package-info">
						<p class="more-than-3rooms">Need more than three rooms?</p>
						<p class="visit">Visit our <a href="#">Group Booking Page</a></p>
					</div>
					</div>
    </div>
    <div class="footer">
