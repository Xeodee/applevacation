<div id="booking-container">
	<div
		...
		<p class="text-right">
			<strong>Lowest possible price is based on hotel, room and
				flights recommended by Apple Vacations.</strong> <br /> Pricing includes
			airfare, hotel, transfers and Taxes + Fees
		</p>
		...
		<div class="options_box">
			<div class="opt active hotel">
				<div class="title">
					<span class="icon icon-booking-hotel">icon</span> Hotel &amp; Rooms
				</div>
				<div class="details">
					<p class="black">Lowest price based on:</p>
					<p>
						Dreams Cancun Resort <br />+ Spa <span>Deluxe Ocean Front
							Room</span>
					</p>
					<a> edit</a>
				</div>
			...
			<div class="opt  flight">
				<div class="title">
					<span class="icon icon-booking-flight">icon</span> Select Flights
				</div>
				<div class="details">
					<p>
	...
	<!-- end selection header -->
	<link href="css/hotelAvailable.css" rel="stylesheet" type="text/css"
		media="screen" />
				...
				<div class="sidebar-slidetoggle">
					...
					<div class="apple-rating">
						<select id="webmenu" name="webmenu">
							<option value="Luxurious0"
								data-image="<%=request.getContextPath()%>/res/images/red-apple-icon.png">Luxurious
							</option>
							<option value="Luxurious1"
								data-image="<%=request.getContextPath()%>/res/images/red-apple-icon.png">Luxurious1</option>
							<option value="Luxurious2"
								data-image="<%=request.getContextPath()%>/res/images/red-apple-icon.png">Luxurious2</option>
							<option value="Luxurious3"
								data-image="<%=request.getContextPath()%>/res/images/red-apple-icon.png">Luxurious3</option>
							<option value="Luxurious4"
								data-image="<%=request.getContextPath()%>/res/images/red-apple-icon.png">Luxurious4</option>
						</select> <a href="">show all</a>
					</div>
				</div>
				<div class="sidebar-slidetoggle">
        ...
        <ul class="checks">
			...
			<div class="narrow-content floatR">
				<div class="narrow-content floatR hotelAvailable">
					<div
						class="results-count-row Content-right-blue gradient-transparent-blue corner-all border-all">
						<div class="hotel-available">
							<span>hotels available</span> <span class="hotels-count">26</span>
						</div>
					...
					<div class="Package-veiw">
						<div class="Package-veiw-list Recommend">
							...
							<div class="Recommendation-text">
								...
								<p>Our recommendations based on best prices, value, quality,
									and our years of travel experience.</p>
							</div>
							<div class="Package-info-L">
								<a class="Selectedhotel" href="#">selected hotel</a> <img
									src="<%=request.getContextPath()%>/res/images/find-vacation-temp.png"
									alt="">
								<p class="price-based-on">Price based on an:</p>
								<p class="view-room-details">DELUXE OCEAN VIEW ROOM</p>
								<p class="inclusive-hotel">All Inclusive Hotel</p>
							</div>
							<div class="Package-info-description">
								<h2>Dreams Riviera Cancun Resport &amp; Spa</h2>
								<span class="cancun">Cancun</span> <a class="red-apple-icon"
									href="#">6</a><span class="hotel-rating-type">LUXURIOUS</span>
								<h6>Free ride from the hotel</h6>
								<p>
									The luxurious Dreams Riviera Cancun will take its personality
									from its incredible location - just 30 minutes from the "hot"
									excitement of Cancun yet right on the "cool" Caribbean close to
									Playa del Carmen and many other of <a class="Readmore">..&nbsp;more
										&raquo;</a>
								</p>
							</div>
							<div class="package-priceinfo">
								<span class="Package-confirm-changetext">Confirm or
									change <a>room type</a> below to continue
								</span>
								<p>VACATIONS FROM</p>
								<p class="price">
									$<b>519</b>.99
							...
							<div class="package-footer">
								...
								<div>
									<a title="view-package-details" href="#"
										class="view-package-details">VIEW HOTEL DETAILS</a>
								</div>
								<div class="choose-room-type expand"
									onclick="MO.AnimateHotelSlideBar(this);">
									<span>Choose Room Type </span>(12) <a class="closed"></a>
								</div>
							</div>
						</div>
						<!-- dropd down to choose room type-->
						<div class="Package-Slider-outer corner-bottom border-all"
							id="pacakgeSlider"
							style="overflow-x: hidden; overflow-y: hidden; display: none;">
							<div class="Package-Slider-inner">
								<ul class="Package-Slider-content" id="ulSliderContainer"
									totalslide="6" currentslide="1">
									<!--Need to specify the width dynamically according to number of  slides-->
									<li>
										<h5>2. Royalty Villa</h5>
										<p>645 sq. ft. Perfect for singles and couples are these
											elegant ocean-view accommodations where tasteful design meets
											pure comfort. 1 King Bed or 2 Double Beds</p> <a
										class="view-room-details" href="#"
										title="view-package-details">VIEW ROOM DETAILS</a>
										<div class="Price-block-bottomright">
											<div class="Price-block">+<p class="price">$<b>519</b>.99 </p></div>
											<p class="inline-block">PER PERSON</p>
										</div> <a class="btn-light-blue continue" href="${pageContext.request.contextPath}/b1_27_flights_departure_return_multi.html">Book Room</a> <a><img
											src="<%=request.getContextPath()%>/res/images/slider-img1.png"
											alt=""></a>
									</li>
									<li class="no-image-li">
										...
										<div class="Price-block-bottomright">
											<div class="Price-block">+<p class="price">$<b>519</b>.99 </p></div>
											<p class="inline-block">PER PERSON</p>
										</div> <a class="btn-light-blue continue" href="${pageContext.request.contextPath}/b1_27_flights_departure_return_multi.html">Book Room</a>
										<div class="no-image">
							...
							<div class="Slide_forward"
								onclick="MO.moveNextHotelSlider(this);" style="display: block;"></div>
							<div class="Slide_back" onclick="MO.movePrevioudSlide(this);"
					...
					<div class="Package-veiw-list">
						...
						<div class="package-priceinfo">
							<span class="Package-confirm-changetext">Confirm or change
								<a>room type</a> below to continue
							</span>
							<p>VACATIONS FROM</p>
							<div class="Price-block">+<p class="price">$<b>519</b>.99 </p></div>
							<p class="inline-block">PER PERSON</p>
...
<!-- / wrapper closed -->.
	<div id="background">
		<img
			src="<%=request.getContextPath()%>/res/images/bg-unrecognized.jpg"
