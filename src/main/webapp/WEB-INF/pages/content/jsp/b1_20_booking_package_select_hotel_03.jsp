<div class="content-center">
	<div class="yellowbkd GetStarted">
    	<p>Not interested in a package?  <span>Design your own by choosing flights and hotels that work for you.&nbsp;&nbsp;<a>Get Started ></a></span></p>
        <a onclick="MO.closeTravel(this)" class="clost-text">CLOSE</a>
    </div>
    <div class="content-center greygradient pie">
    	<h1>Change Your Hotel</h1>
        <ul class="lists">
        	<li>1.Find the flight you want in the list below</li>
            <li>2.Choose "Select & Continue" next to flight you want</li>
        </ul>
    </div>
    <div class="content-center bestvaluepackage">
    	<div class="bestvalue corner-all border-all floatL gradient-transparent-white gradient">
        	<h3 class="label-large-orange">Best Value</h3>
            <div class="Best-value-info">
            	...
            	<h6>united flight:123</h6>
                <p>Chicago(ORD)<span>11:55am</span></p>
                <p>Chicago(ORD)<span>11:55am</span></p>
            </div>
            </div>
            <div class="Best-value-info">
            ...
            <span class="view-flight-details">
           		<a title="view-flight-details" href="#">VIEW FLIGHT DETAILS</a>
                <div class="change-flight-button" href="#">change flight only</div>
            </span>
    	...
    	<div class="Package detail corner-all border-all floatL">
          ...
          <div class="find-vacation-r2">
              <h2 class="find-vacation-h2">Dreams Riviera Cancun Resport &amp; Spa</h2>
              <span class="hotel-rating-type hotel-rating-sub">Cancun</span>
              <span class="red-apple-icon">6</span>
              <span class="hotel-rating-type">LUXURIOUS</span><br/>
              
              <p>To chooose this hotel please choose your desired room type below.</p>
          </div>
          <div>
          ...
          <span class="view-package-details"><a href="#" title="view-package-details">VIEW HOTEL DETAILS</a></span>          
       	...
       	<div class="Package packagevalue corner-all border-all floatR">
            ...
            <div class="vacation-price-details-div CF-Price-block">
                <div class="price-tag">
...
<!--<div id="refine-search">
    <div class="refine-top black-shadow">Refine Your Search</div> 
    	...
    	<div class="hr"></div>
        <h2 class="title text-shadow">Apple Rating <img src="images/b1_52/tip_question.png" alt="" class="tooltip" /></h2>
        <div class="AppleRatingDropdown"> 
            <select class="select">      
                <option value="0" title="images/apple_exceptional.png">Exceptional 1</option>
                <option value="1" title="images/apple_exceptional.png">Exceptional 2</option>
                <option value="2" title="images/apple_exceptional.png">Exceptional 3 </option>
                <option value="3" title="images/apple_exceptional.png">Exceptional 4</option>
                <option value="4" title="images/apple_exceptional.png">Exceptional 5</option>
            </select>
       </div>
                ...
                <div class="Package-Slider-inner">
                      <ul class="Package-Slider-content" id="ulSliderContainer" totalslide="6" currentslide="1"> <!--Need to specify the width dynamically according to number of  slides-->
                          <li>                              
                              ...
                              <a href="${pageContext.request.contextPath}/b1_33_extrassummary.html" class="btn-light-blue continue">Book Room</a>
