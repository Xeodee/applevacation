...
(function ($, window, document) {
    ...
    dropdownTemplate = [
      '<div class="dk_container" id="dk_container_{{ id }}" tabindex="{{ tabindex }}">',
        '<a class="dk_toggle">',
          '<span class="dk_label {{ class }}">{{ label }}</span>',
        '</a>',
  ...
  ;
    ...
    methods.init = function (settings) {
      ...
      ;
            ...
            if (data.id) {
                ...
                data.className = _notBlank($original.attr('class'));
            }
    ...
    function _updateFields(option, $dk, reset) {
        ...
        var spanDKLabel = $dk.find('.dk_label');
        className = option.parent().attr('class');
        $(spanDKLabel).attr("class", "dk_label " + className);
        $(spanDKLabel).text(label);
    ...
    ;
        ...
        ;
                ...
                if ($option.attr('class') != undefined) {
                    oTemplate = oTemplate.replace('{{ class }}', $option.attr('class'));
                } else {
                    oTemplate = oTemplate.replace('{{ class }}', 'option');
                }
